...
from prune_utils import freeze_vars_by_key, unfreeze_vars_by_key
...
class BilevelTrainer:
    def __init__(self, model, train_loader, prune_rate, momentum=0.9):
        ...
        self.optimizer_ft = optim.SparseAdam(model.parameters(), lr=config_dict['ft_label'], momentum=momentum)
